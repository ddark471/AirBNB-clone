  ...
  return (
    <div className="wrap">
      ...
      <div className="wrap__main">
          <div className="wrap__card" id="wrap__card">
            <img src="./image-12.svg" alt="" className="card__image"/>
            <ul className="card__description">
              <li className="description__rating">
              ...
              <li className="description__comment">Life lessons with Katie Zaferes</li>
              <li className="description__price">From $136 <span className="price__amount">/ person</span></li>
            </ul>
          </div> 
      </div>
    </div>
